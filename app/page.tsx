      ...
      <header className="bg-white border-b border-stone-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="text-sm font-medium flex items-center gap-4">
             ...
             <span className="text-xs px-2 py-1 bg-stone-100 text-stone-500 rounded-md hidden sm:inline-block">
               非臨床教育工具
             </span>
          </nav>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        {appState === "FORM" && (
          <div className="space-y-8 animate-in fade-in fill-mode-both duration-500">
            <div className="max-w-2xl">
              <h1 className="text-3xl font-semibold tracking-tight text-stone-900 mb-3">夢境紀錄與結構化反思</h1>
        ...
        {appState === "LOADING" && (
          <div className="flex flex-col items-center justify-center py-32 space-y-4 animate-in fade-in fill-mode-both duration-500">
            ...
            <p className="text-stone-500 font-medium">系統正在分析與建立框架，請稍候...</p>
          </div>
        )}
