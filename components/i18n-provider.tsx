...
const translations = {
  zh: {
    ...
    archive_too_large: "輸入字數過多，伺服器無法處理，請縮減比較內容。",
    archive_timeout: "伺服器超時 (504)，比較過程花費了太長時間。由於伺服器有處理時間限制，請嘗試減少比較的夢境數量後再試一次。",
    archive_service_busy: "AI 服務器目前正處於高負載狀態，請稍後再試。",
    archive_blocked: "檢測到無效字元或嘗試繞過系統的指令，拒絕請求。",
    archive_compare_failed: "比較失敗，請稍後再試。",
    archive_network_error: "網路連線失敗，或輸入資料超出上限。",
    crisis_title: "暫停分析",
  ...
  en: {
    ...
    archive_too_large: "Input too large. Please shorten your dream content before comparing.",
    archive_timeout: "Server timeout (504). The comparison took too long. Please try selecting fewer items to compare.",
    archive_service_busy: "The AI service is currently experiencing high demand. Please try again later.",
    archive_blocked: "Invalid characters or restricted keywords detected.",
    archive_compare_failed: "Comparison failed, please try again.",
    archive_network_error: "Network connection failed or input data is too large.",
