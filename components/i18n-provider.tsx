...
const translations = {
  zh: {
    ...
    tutorial_step2_desc: "分析完成後，請務必點擊「下載 JSON」將報告保存至你的裝置。這讓你保有你的個人資料，並為未來的比較做準備。",
    ...
    archive_themes_title: "反覆出現的主題",
    archive_import_hint: "請匯入至少 2 筆以上的夢境紀錄以啟用比較功能。",
    archive_no_symbols: "無明顯重複象徵",
    archive_no_emotions: "無明顯情感一致性",
    archive_no_themes: "無明顯雷同主題",
    archive_invalid_file: "檔案格式不符，請選擇透過系統下載的夢境 JSON 檔案。",
    error_too_large: "輸入字數過多，伺服器無法處理，請縮減夢境內容。",
    error_timeout: "伺服器超時 (504)，分析花費了太長時間。請嘗試精簡您的夢境內容與細節後再試一次。",
    error_timeout_compare: "伺服器超時 (504)，比較過程花費了太長時間。請嘗試減少比較的夢境數量後再試一次。",
    error_service_busy: "AI 服務器目前正處於高負載狀態，請稍後再試。",
    error_blocked: "檢測到無效字元或嘗試繞過系統的指令，拒絕請求。",
    error_generic: "分析過程中發生錯誤，請稍後再試。",
    error_compare_failed: "比較失敗，請稍後再試。",
    error_network: "連線失敗，請檢查網路狀態，或是您的輸入內容可能超出伺服器可接受的上限。",
    crisis_title: "暫停分析",
  ...
  en: {
    ...
    form_draft_confirm: "Click again to confirm",
    emo_joy: "Joy",
    emo_trust: "Trust",
    emo_fear: "Fear",
    ...
    md_summary: "Summary",
    md_jungian: "Jungian Perspective",
    md_appendix: "Alternative Perspectives Appendix",
    ...
    archive_themes_title: "Recurring Themes",
    archive_import_hint: "Please import at least 2 dream records to enable comparison.",
    archive_no_symbols: "No clear recurring symbols",
    archive_no_emotions: "No clear emotional consistency",
    archive_no_themes: "No recurring theme",
    archive_invalid_file: "Invalid file format. Please select JSON files generated by this system.",
    error_too_large: "Input too large. Please shorten your dream content.",
    error_timeout: "Server timeout (504). The analysis took too long. Please try shortening your content, or try again later.",
    error_timeout_compare: "Server timeout (504). The comparison took too long. Please try selecting fewer items to compare.",
    error_service_busy: "The AI service is currently experiencing high demand. Please try again later.",
    error_blocked: "Invalid characters or restricted keywords detected.",
    error_generic: "An error occurred during analysis. Please try again.",
    error_compare_failed: "Comparison failed, please try again.",
    error_network: "Connection failed. Please check your network or ensure your input is not excessively long.",
    ...
    crisis_return: "Return to Home Page"
  }
};
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  // Keep the document language attribute in step with the UI language for
  // screen readers; the server render defaults to zh (see app/layout.tsx).
  useEffect(() => {
  ...
  if (!mounted) {
    ...
    return (
      <I18nContext.Provider value={{ lang: "zh", setLang: () => {}, t: (k) => translations.zh[k] || k }}>
        {children}
