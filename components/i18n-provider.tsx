...
const translations = {
  zh: {
    ...
    api_key_label: "自訂 Gemini API Key (選填):",
    api_key_placeholder: "如果在預設額度耗盡時，可在此輸入個人 API Key 繼續使用",
    tutorial_btn: "使用教學",
  ...
  en: {
    ...
    api_key_label: "Custom Gemini API Key (Optional):",
    api_key_placeholder: "If default quota is exhausted, enter your personal API key here to continue",
