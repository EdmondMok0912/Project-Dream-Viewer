  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-4 rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
        <div>
          <h2 className="text-lg font-bold text-stone-900">核心夢境紀錄</h2>
          <p className="text-sm text-stone-500">請盡可能詳細地描述您昨晚的夢境內容。</p>
        </div>

        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">夢境標題</label>
            <Input {...register("title")} placeholder="為您的夢境取個名字" />
            {errors.title && <p className="text-xs text-red-500">{errors.title.message}</p>}
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">記錄日期</label>
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-stone-700">夢境內容</label>
          <Textarea 
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">醒來後的情緒</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">夢中的主要情緒</label>
      ...
      <div className="space-y-4 rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
        <div>
          <h2 className="text-lg font-bold text-stone-900">象徵與聯想</h2>
          <p className="text-sm text-stone-500">拆解夢境元素，並記錄您個人的第一直覺聯想。</p>
        </div>

        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">關鍵人物 (選填)</label>
            <Input {...register("keyCharacters")} placeholder="出現了誰？" />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">關鍵場景 (選填)</label>
            <Input {...register("keyScenes")} placeholder="在什麼地方？" />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-stone-700">特殊符號/物件 (選填)</label>
            <Input {...register("keySymbols")} placeholder="引人注意的物品？" />
          </div>
        </div>

        <div className="space-y-2">
          <label className="text-sm font-medium text-stone-700">個人聯想</label>
          <Textarea 
      ...
      <div className="space-y-4 rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
         <div>
          <h2 className="text-lg font-bold text-stone-900">現實連結</h2>
          <p className="text-sm text-stone-500">協助系統將夢境與您當前的生活狀態建立連結。</p>
        </div>
        
        <div className="space-y-2">
          <label className="text-sm font-medium text-stone-700">近期生活事件/壓力源 (選填)</label>
          <Textarea 
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-stone-700">其他備註 (選填)</label>
